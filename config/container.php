...
use Acruxx\Educacao\Aluno\Domain\Listener\AcionaOsIlluminatListener;
...
$container[Dispatcher::class] = static function () {
  ...
  $dispatcher->attach(AlunoFoiCadastrado::class, new AcionaOsIlluminatListener());
  
  $dispatcher->attach(AlunoFoiArquivado::class, new NotificaMaeDoAlunoListener());
  $dispatcher->attach(AlunoFoiArquivado::class, new AcionaOsIlluminatListener());
  /* $dispatcher->attach(AlunoFoiArquivado::class, "Outro Listener Qualquer"); */
